...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/ui-elements/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Nov 2021 20:16:40 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>::Fela Homes:: Signin </title>
                    ...
                    <div class="row g-0">
                        ...
                        <div
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                <!-- Form -->
                                <form class="row g-1 p-3 p-md-4" action="{{ route('login') }}" method="POST"> @csrf
                                    ...
                                    <div class="col-12 text-center mb-4">
                                        <a class="btn btn-lg btn-light btn-block" href="">
                                            <span class="d-flex justify-content-center align-items-center">
                                                <img class="avatar xs me-2" src="/d_assets/images/google.svg"
...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/ui-elements/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Nov 2021 20:16:42 GMT -->
